...
width: 100%;
height: 65px;
background-color : rgba(0,0,0,0.7); ; //////////////////追従ヘッダーの背景色/////////////////
text-align : center;
/position: fixed;/
}
.headMenu0{
...
a { color:white;
font-size: 15px ;
}/*新型コロナウイルスに対する取り組みの最新情報をご案内のリンク文字色*/
.header{
position:fixed;
width: 100%;
top : 0 ;
...
.InitiativesForTheNewCoronavirus{
position: relative ;
left : 505px ;
}
.SecondLine{
